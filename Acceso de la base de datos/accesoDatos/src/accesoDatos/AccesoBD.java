...
public class AccesoBD {
    ...
    /**
     * M�todo constructor que recibe todos los par�metros necesarios para abrir
     * una conexi�n v�lida
     *
     * @param driver especificaci�n del tipo de driver que se utiliza, el cual
    ...
    /**
     * M�todo que ejecuta una sentencia en la base de datos, la cual no tiene
    ...
    /**
     * M�todo que ejecuta una sentencia en la base de datos y devuelve un
    ...
    /**
     * Permite controlar el t�rmino una transacci�n desde afuera. A partir de
     * este momento todas las sentencias se ejectur�n de forma individual en la
     * base de datos
     *
     */
    ...
    /**
     * M�todo sobreescrito de la clase Object que es invocado por el Garbage
     * Collector cuando es invocado libera la conexi�n abierta durante la
     * creaci�n del objeto
     *
     */
    @Override
